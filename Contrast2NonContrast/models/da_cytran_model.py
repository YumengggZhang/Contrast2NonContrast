...
class DACytranModel(BaseModel):
 ...
 #                                       not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids)
    ...
    def backward_G(self):
        ...
        # GAN loss D_A(G_A(A)) and its rotated versions
        ...
        # GAN loss D_B(G_B(B)) and its rotated versions
        ...
        # combined loss and calculate gradients
        self.loss_G = self.loss_G_A + 0.2/4.*(self.loss_G_A  + self.loss_G_A_1 + self.loss_G_A_2 + self.loss_G_A_3) + \
                      self.loss_G_B + 0.2/4.*(self.loss_G_B  + self.loss_G_B_1 + self.loss_G_B_2 + self.loss_G_B_3) + \
